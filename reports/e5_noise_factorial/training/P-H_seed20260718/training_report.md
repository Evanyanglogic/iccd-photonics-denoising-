...
- Experiment ID: `e5_P-H_seed20260718`
...
- Train L1: 0.000453741
- Validation L1: 0.00068698
- Validation PSNR/SSIM: 47.1322 / 0.999769
- Noisy-input PSNR/SSIM on same validation subset: 45.8163 / 0.996647

## Outputs

- Config: `reports\e5_noise_factorial\training\P-H_seed20260718\config.json`
- Metrics: `reports\e5_noise_factorial\training\P-H_seed20260718\metrics.csv`
- Validation rows: `reports\e5_noise_factorial\training\P-H_seed20260718\validation_predictions.csv`
- Best checkpoint: `reports\e5_noise_factorial\training\P-H_seed20260718\checkpoints\best.pth`
- Last checkpoint: `reports\e5_noise_factorial\training\P-H_seed20260718\checkpoints\last.pth`
- Samples: `reports\e5_noise_factorial\training\P-H_seed20260718\samples`
