...
- Experiment ID: `e5_P-H_seed20260717`
...
- Train L1: 0.000449068
- Validation L1: 0.000677278
- Validation PSNR/SSIM: 47.1031 / 0.999766
- Noisy-input PSNR/SSIM on same validation subset: 45.8163 / 0.996647

## Outputs

- Config: `reports\e5_noise_factorial\training\P-H_seed20260717\config.json`
- Metrics: `reports\e5_noise_factorial\training\P-H_seed20260717\metrics.csv`
- Validation rows: `reports\e5_noise_factorial\training\P-H_seed20260717\validation_predictions.csv`
- Best checkpoint: `reports\e5_noise_factorial\training\P-H_seed20260717\checkpoints\best.pth`
- Last checkpoint: `reports\e5_noise_factorial\training\P-H_seed20260717\checkpoints\last.pth`
- Samples: `reports\e5_noise_factorial\training\P-H_seed20260717\samples`
