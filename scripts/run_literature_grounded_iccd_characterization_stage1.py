...
def methods() -> list[dict[str, Any]]:
    ...
    raw = [
        ("M01","PTC","standard photon transfer curve","R01;R04;R05","LEVEL-S","paired raw flat and dark frames across >=50 signal points","homogeneous calibrated monochromatic flat","required","matched","pairs/stacks","exposure/irradiance, gain, temperature","radiometry and fixed camera settings","mean-variance, gain, read noise, full well","K, read noise, saturation capacity","uniform stable illumination and linear response","scene leakage, nonlinearity, covariance","NOT-ELIGIBLE","photon-transfer method only after compliant acquisition","high","high"),
        ("M02","PTC","difference-frame PTC","R04;R05","LEVEL-A","paired same-level flats and matched bias/dark","uniform flat","required","matched","two or more per level","exposure/irradiance and settings","dark subtraction and pair matching","temporal variance with FPN suppression","operational/system gain if prerequisites hold","pair differences remove static spatial pattern","motion/flicker/unequal flats","NOT-ELIGIBLE","difference-frame temporal mean-variance diagnostic","high","high"),
        ...
        ("M04","Dark","dark-current exposure sequence","R01;R09","LEVEL-S","capped matched dark stacks at >=6 exposure times","dark","required","required","required","exposure, temperature, mode, gain","matched settings","dark mean/variance versus exposure","dark-current proxy or calibrated current","same device/mode and stable temperature","untraced darks, compensation, hot-pixel nonlinearity","NOT-ELIGIBLE","dark-sequence operational trend only after metadata recovery","high","medium"),
        ("M05","Dark","temporal dark noise/read-noise proxy","R01;R09","LEVEL-S","short-exposure matched dark stack","dark","single verified short exposure","required","required","temperature, mode, gain","camera offset/underflow known","dark temporal std","temporal dark-noise proxy","dark current negligible or modeled","unknown compensation/mismatch","NOT-ELIGIBLE","temporal dark-noise proxy","high","medium"),
        ("M06","Spatial","DSNU","R01;R02","LEVEL-S","averaged matched dark stack","dark","verified","required","stack","temperature, gain, mode","temporal-noise correction","dark signal nonuniformity, row/col/pixel terms","DSNU1288","matched dark and standard procedure","scene or unmatched dark contamination","NOT-ELIGIBLE","DSNU-like only for matched dark data","high","low"),
